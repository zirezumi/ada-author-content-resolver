...
<body>
  <div class="wrap">
    <div class="card">
      ...
      <p class="sub">Enter a book title. This page calls <code>/api/resolve</code> and displays the resolved author and website.</p>
  ...
  <script>
    ...
    function showResults(payload) {
      ...
      $("out-debug").textContent = payload._debug ? "debug info present" : "";
    }

    async function callAPI(bookTitle) {
      const body = {
        book_title: bookTitle,
        include_search: true,
        strict_author_match: true,
        require_book_match: true,
        fallback_author_only: true,
        min_confidence: 0.35,
